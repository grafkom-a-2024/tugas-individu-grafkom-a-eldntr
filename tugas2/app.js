...
function createPLetterVertices(centerX, centerY, outerRadius, numSegments) {
    let positions = [];
...
const positions = createPLetterVertices(x, y, outerRadius, numSegments);
...
function drawScene(translation, rotation, scale) {
